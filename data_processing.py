...
-- Try out Assessor web form scraping idea
...
Scrape Cook County PINs (about 158k of them) from the Cook County Assessor's website
Unfortunately, only about 250 tax codes are in this file.
JSON generated by cook_county_assessor_scraper, a crawler written by Steve Vance

Eventually, I'll want to modify the cook_county_assessor_scraper to take individual address inputs
--------------------------------------------------------------------------------
"""

    properties = pd.read_json(r"C:\Users\midde\OneDrive\Documents\GitHub\cook_county_assessor_scraper\cook_county_assessor_scraper\properties.json", lines=True)
len(properties['taxcode'].unique()) # 247 tax codes represented here
